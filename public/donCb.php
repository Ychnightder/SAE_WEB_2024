...
<html lang="fr">
  <head>
    ...
    <link rel="stylesheet" href="../public/assets/css/donCbCheque.css" />
    <title>Donnation CB</title>
  </head>
  <body>
    <header class="header">
      <nav class="nav">
        <div class="logo-container">
          <a class="logo-link" href="../public/index.php">
            <img class="logo" src="/assets/img/shared/logo.png" alt="logo" />
          </a>
        </div>

        <div class="nav-links">
          <button type="button" class="nav-button">
            <a class="links" href="../public/index.php">Accueil</a>
          </button>
          ...
          <button type="button" class="nav-button">
            <a class="links" href="../public/contact.php">Contact</a>
          </button>
        </div>
      ...
      <div class="main-footer">
        <div class="autisme-footer">
          ...
          <div class="contact-box">
            <a class="contact-links" href="/public/contact.php">
              <svg
                viewBox="0 0 24 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
